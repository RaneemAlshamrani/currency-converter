...
@Component({
  selector: 'app-convertcurrancy',
  standalone: false,
  templateUrl: './convertcurrancy.component.html',
  styleUrl: './convertcurrancy.component.css'
})
export class ConvertcurrancyComponent {
  currancy = [
...
amount:string="";
get_currancy(){
  fetch(`https://api.currencylayer.com/convert?from=${this.from_convert}&to=${this.to_convert}&amount=${this.amount}&access_key=f8ba4dd5f7c512af738b8d7945bcf4d5`)
